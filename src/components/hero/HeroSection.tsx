  ...
  return (
    <section className="hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="hero-bg absolute inset-0">
        <div className="hero-animation w-full h-full"></div>
        <div className="absolute inset-0 bg-black bg-opacity-40"></div>
        
        {/* Floating particles */}
        <div className="absolute inset-0">
          <div className="floating-animation absolute top-20 left-10 w-2 h-2 bg-white bg-opacity-30 rounded-full"></div>
          <div className="floating-animation absolute top-40 right-20 w-3 h-3 bg-blue-400 bg-opacity-40 rounded-full" style={{ animationDelay: '1s' }}></div>
          <div className="floating-animation absolute bottom-40 left-20 w-2 h-2 bg-purple-400 bg-opacity-30 rounded-full" style={{ animationDelay: '2s' }}></div>
          <div className="floating-animation absolute bottom-20 right-10 w-4 h-4 bg-white bg-opacity-20 rounded-full" style={{ animationDelay: '0.5s' }}></div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 border border-white border-opacity-20 service-card">
